    ...
    const testimonials: Testimonial[] = [
        {
            ...
            rating: 5,
            text: "Kalo ngomongin rumah yang aksesnya gampang, fasilitasnya juga lengkap, ini sih pilihan yang terbaik terutama di daerah Purwokerto Selatan.",
        },
        {
            id: 2,
            name: "Bayu Adi",
            ...
            image: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1762656135/download_cszbzm.png",
            rating: 5,
            text: "Maa syaa Allah rumah dan tempatnya asri. Jadi pengin punya rumah di sini.",
        },
