...
export default function Gallery() {
  ...
  const galleryImages = [
    ...
    {
      src: "https://www.instagram.com/reel/DOVdSP1kXen/?igsh=bTVqamV1enhkYWEw",
      alt: "Instagram Reel 1",
      type: "video",
      thumbnail: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1763238539/mansion-48_urghn2.avif",
    },
    {
      src: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1763238540/mansion-54_necnhf.avif",
      alt: "Instagram Reel 2",
      type: "image",
      thumbnail: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1763238540/mansion-54_necnhf.avif",
    },
  ...
  return (
    <section id="gallery" className="section">
      <div className="container">
        <h2 className="section-title">Gallery Sapphire Madani Tegal</h2>
        <p className="section-subtitle">
          Temukan keindahan dan kenyamanan rumah impian Anda di Sapphire Madani Tegal. Setiap sudut dirancang dengan
