...
export default function Properties() {
  ...
  const properties: Property[] = [
    // Tipe Rumah
    {
      ...
      area: "48",
      description:
        "Tipe 48/91 dengan luas bangunan 48 m² dan luas tanah 91 m² adalah pilihan sempurna untuk keluarga modern di Sapphire Mansion Purwokerto. Desain minimalis eksklusif dengan layout yang efisien untuk memaksimalkan setiap ruang.",
      certificate: "SHM",
    },
    {
      id: 2,
      ...
      area: "54",
      description:
        "Tipe 54/105 dengan luas bangunan 54 m² dan luas tanah 105 m² menawarkan ruang yang lebih lega dengan layout yang fungsional. Cocok untuk keluarga muda di Sapphire Mansion Purwokerto dengan desain eksklusif modern.",
      certificate: "SHM",
    },
    {
      id: 3,
      ...
      area: "54",
      description:
        "Tipe 54/120 dengan luas bangunan 54 m² dan luas tanah 120 m² menawarkan ruang yang nyaman untuk keluarga modern di Sapphire Mansion Purwokerto dengan 2 kamar tidur dan desain eksklusif yang optimal.",
      certificate: "SHM",
    },
    {
      id: 4,
      ...
      area: "69",
      description:
        "Tipe 69/135 dengan luas bangunan 69 m² dan luas tanah 135 m² menyediakan ruang yang lebih spasious untuk keluarga besar di Sapphire Mansion Purwokerto dengan desain eksklusif dan elegan.",
      certificate: "SHM",
    },
    {
      id: 5,
      ...
      area: "175",
      description:
        "Tipe 175/190 dengan luas bangunan 175 m² dan luas tanah 190 m² adalah pilihan premium dan luxury di Sapphire Mansion Purwokerto untuk keluarga yang menginginkan hunian berkualitas tinggi dengan investasi bernilai tinggi.",
      certificate: "SHM",
    },
  ]
  ...
  const siteplan = {
    id: "siteplan-1",
    image: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1762052665/Screenshot_2025-11-02_at_09.56.54_iwqikq.avif",
    name: "Siteplan Sapphire Mansion Purwokerto",
    description:
      "Masterplan perumahan Sapphire Mansion Purwokerto dengan layout strategis menampilkan denah unit, jalan luas, ruang terbuka hijau, tempat ibadah terintegrasi, taman, dan fasilitas dengan sistem keamanan terpadu (petugas sekuriti, one gate system, CCTV, patroli 24 jam) untuk kenyamanan optimal penghuninya.",
  }
  ...
  const location = {
    embed: '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3956.1916700615966!2d109.26018562590514!3d-7.444034373353794!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e655c19c43006c1%3A0x67be7451959f1115!2sPerumahan%20Sapphire%20Mansion!5e0!3m2!1sen!2sid!4v1762052859562!5m2!1sen!2sid" style="width:100%;height:100%;border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>',
    name: "Denah Lokasi Sapphire Mansion Purwokerto",
    description: "Lokasi strategis di pusat Purwokerto, berada di tengah 4 jalur utama kota dengan akses mudah ke berbagai fasilitas pendidikan (Fakultas Kedokteran Unsoed, IT Telkom, Fakultas Kesehatan UMP), kesehatan (RS Wiradadi Husada, RSUD Prof. Dr. Margono Soekarjo, RS Orthopaedi Purwokerto), pusat perbelanjaan (Depo Pelita Mall, Rita Pasaraya), dan fasilitas publik lainnya di Kota Purwokerto.",
  }
    ...
    <section id="tipe-rumah" className="section">
      <div className="container">
        ...
        <p className="section-subtitle">
          Temukan rumah impian Anda di Sapphire Mansion Purwokerto dengan berbagai pilihan tipe rumah eksklusif yang dirancang untuk kenyamanan maksimal di lokasi prime Purwokerto dengan harga investasi terbaik.
        </p>
        ...
        {activeType === "tipe-rumah" ? (
          ...
          <div className="specifications-container">
            ...
            <div className="specifications-content">
              <h3 className="specifications-title">Spesifikasi Sapphire Mansion Purwokerto</h3>
              <p style={{ fontSize: '14px', color: '#666', marginBottom: '20px', fontStyle: 'italic' }}>Hadir dengan Fitur Smart Door Lock</p>
              ...
              <div className="specifications-list" style={{ position: 'relative' }}>
                ...
                {!showAllSpecs && (
                  <div className="specification-item" style={{ position: 'relative' }}>
                    ...
                    <span className="specification-value">{specificationsSaba.septictank}</span>
                    <div style={{
                      position: 'absolute',
                      top: 0,
                      left: 0,
                ...
                {showAllSpecs && (
                  <>
                    ...
                    <div className="specification-item">
                      <span className="specification-label">Septic Tank:</span>
                      <span className="specification-value">{specificationsSaba.bioSeptictank}</span>
                    </div>
                    <div className="specification-item">
                      <span className="specification-label">Carport:</span>
                      <span className="specification-value">{specificationsSaba.carport}</span>
                    </div>
                    <div className="specification-item">
                    ...
                    <div className="specification-item">
                      ...
                      <span className="specification-value">{specificationsSaba.mejaDapur}</span>
                    </div>
                    <div className="specification-item">
                      <span className="specification-label">Stop Kontak:</span>
                      <span className="specification-value">{specificationsSaba.stopKontak}</span>
                    </div>
                    <div className="specification-item">
                      <span className="specification-label">Lampu:</span>
                      <span className="specification-value">{specificationsSaba.lampu}</span>
                    </div>
                  </>
                )}
              </div>
