            ...
            <div className="footer-container">
                ...
                <div className="footer-bottom">
                    <div className="footer-logo">
                        <Image
                            src="https://res.cloudinary.com/dx8w9qwl6/image/upload/v1757392355/sapphiregraha_vdlzir.png"
                            alt="Sapphire Mansion Purwokerto Logo"
                            width={80}
                            height={50}
                    ...
                    <div className="footer-copyright">
                        &copy; {new Date().getFullYear()} Sapphire Mansion by Sapphire Grup.
                    </div>
                    ...
                    <div className="footer-social">
                        ...
                        <Link href="https://www.facebook.com/sapphiregrahaofficial" target="_blank" rel="noopener noreferrer" className="footer-social-link">
