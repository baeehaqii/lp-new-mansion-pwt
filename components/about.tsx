            ...
            <div className="modal-content">
              ...
              <div className="modal-description">
                ...
                <ul className="modal-list">
                  ...
                  <li>8 menit ke fasilitas pendidikan</li>
                ...
                <ul className="modal-list">
                  <li>Keamanan 24 jam dengan sistem CCTV dan one gate system</li>
                  <li>Akses jalan lebar dengan utilitas rapi</li>
                  <li>Area hijau yang menambah kenyamanan lingkungan</li>
                  <li>Pilihan rumah dan ruko untuk kebutuhan hunian maupun usaha</li>
                </ul>
              </div>
            </div>
          </div>
