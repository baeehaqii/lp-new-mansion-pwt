...
export const metadata: Metadata = {
  title: "Sapphire Mansion Purwokerto - Hunian Eksklusif Modern di Purwokerto",
  description: "Temukan hunian eksklusif bergaya modern di Sapphire Mansion Purwokerto, didesain khusus untuk menghadirkan kenyamanan dan prestise bagi penghuninya. Dilengkapi fasilitas lengkap, sistem keamanan 24 jam, lokasi prime strategis, dan akses mudah ke pusat kota. Dengan nilai investasi tinggi dan reputasi Sapphire Grup sebagai developer berpengalaman.",
  icons: {
  ...
  keywords: [
    ...
    "Rumah Purwokerto",
    "Hunian Modern Purwokerto",
    "Properti Purwokerto",
    "Sapphire Mansion",
    "Rumah Eksklusif Purwokerto",
    "Perumahan Premium",
    "Developer Kredibel",
    "Legalitas Terjamin",
    "Tengah 4 Jalur Utama Purwokerto",
    "Lokasi Prime Purwokerto",
  ],
}
